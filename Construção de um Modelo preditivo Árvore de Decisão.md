...
* Deve haver alguma campanha especial para atrair usuários da plataforma Mac.
  ...
  **- Justificativa -** O grupo com menor proporção de usuários é o de usuários da plataforma Mac que representa somente (3,2 %) do total de todos os compradores. Nessa campanha especial seria interessante buscar atingir os dois grupos de compradores nessa plataforma.  
