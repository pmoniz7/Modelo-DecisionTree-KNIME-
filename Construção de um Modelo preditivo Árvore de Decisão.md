...
Essas tabelas foram convertidas em arquivos para o Excel com extensão.csv para  uso nesse Projeto.<br/>
...
* Fazer  promoções oferecendo descontos especiais aos compradores (PennyPinchers) para comprar itens que custam em média mais de US $ 5
 * - Justificativa - Pode-se observar independente do tipo de      
      plataforma utilizada pelos compradores (851), que maioria 501 são compradores classificados como **("PennyPinchers")**

Podemos aumentar uma campanha que oferece iphone a Penny Pinchers compradores com a intenção de aumentar as vendas de itens

1. Pode ser se mais iPhones foram fornecidos para PennyPinchers a receita iria aumentar.

2. Se podemos subir o preço para o PennyPinchers a receita pode aumentar.

Após usuários de android, o Windows tem mais usuários. A empresa deve se concentrar para implantar seu produto em usuários do Windows também.

2. Usuários de Mac são muito baixos. Deve haver alguma campanha especial para atrair usuários de mac também.

1. Faça promoções temporárias para incentivar Penny Pinchers para comprar itens que custam mais de 5 dólares.

2. Faça pacotes de itens especiais, com 3 ou 4 itens para os usuários brincando com IPhone, para incentivo para comprar mais itens (menos de US $ 5 ou mais).
