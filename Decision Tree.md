...
**combinado.csv**  
* userId: o ID de usuário                                                                                                       * userSessionId: o ID do usuário na  Sessão 
* teamLevel : o nível da equipe durante esta sessão
* platformType: plataforma usada pelo usuário
* count_gameclicks  : número total de game clicks por usuário  na sessão                                                                                                                            * count_hits:  número total de game hits por usuário na sessão                                                           * count_buyId: número total de compras por usuário na sessão                                                  * avg_price: Preço médio de compra por usuário  para sessão 
